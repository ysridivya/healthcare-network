...
describe('GenerateLabReportComponent', () => {
  ...
  let mockGenerateLabReportService;
  let mockDataService

  beforeEach(async(() => {

    mockGenerateLabReportService = sinon.createStubInstance(GenerateLabReportService);
    mockGenerateLabReportService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: GenerateLabReportService, useValue: mockGenerateLabReportService },
