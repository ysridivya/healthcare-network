...
describe('CreateAppointmentComponent', () => {
  ...
  let mockCreateAppointmentService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateAppointmentService = sinon.createStubInstance(CreateAppointmentService);
    mockCreateAppointmentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateAppointmentService, useValue: mockCreateAppointmentService },
