...
function getDoctor(id) {
    ...
    .then(function (doctor) {
        // Process the the vehicle object.
        console.log("getDoctor : "+doctor.DoctorId);
    })
    .catch(function (error) {
...
async function processResolveAppointment(res_appointment){
    ...
    try{
        if(res_appointment.appointment.forDoctor.DoctorId != res_appointment.doctorId) {
        ...
        var factory = getFactory();
        var new_report = factory.newResource('org1.healthcare.biznet','PatientReport',"P"+res_appointment.appointment.byPatient.PatientId+"A"+res_appointment.appointment.appointmentId);
