...
async function processResolveAppointment(res_appointment){
    ...
    try{
        ...
        var factory = getFactory();
        var new_report = factory.newResource('org1.healthcare.biznet','PatientReport',"P"+res_appointment.appointment.byPatient.getIdentifier()+"A"+res_appointment.appointment.appointmentId);
        ...
        new_prescription.completed = true;
